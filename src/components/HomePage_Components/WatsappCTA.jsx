    ...
    <div className="fixed bottom-5 left-5 z-10">
      ...
      >
        <div
          ...
          transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg cursor-pointer group"
        >
          <div className="flex">
          ...
          <p
            className="text-white font-semibold sm:block hidden group-hover:shadow-[0px_3px_5px_#014d4d]"
          >
            Get Instant Quote
          </p>
        </div>
