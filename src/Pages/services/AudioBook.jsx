...
function AudioBook() {
   const { audioBookContent } = useContext(GlobalContext)
    ...
    <>
      <div className="w-full h-auto flex flex-col">
        ...
        <section className="hero-Section bg-image3 w-full relative py-15 bg-gray-900 flex justify-center items-center">
          <HeroSection onOpenQuote={() => setIsFormOpen(true)} obj = {audioBookContent.heroSection}  />
        </section>
        ...
        <section className="w-full h-auto flex justify-center">
          <PublishingJourney obj= {audioBookContent.publishingJourney} />
        </section>

        <section className="2xl:w-[65%] xl:w-[85%] lg:w-[90%] md:w-[95%] sm:w-[80%] w-[90%] mx-auto">
          <CTA onOpenQuote={() => setIsFormOpen(true)}  obj = {audioBookContent.CTA}/>
        </section>

        <section className="2xl:w-[65%] xl:w-[85%] lg:w-[90%] md:w-[95%] sm:w-[80%] w-[90%] mx-auto">
          <ServiceCard  obj= {audioBookContent.ourApproach}/>
        </section>

        <section className="2xl:w-[65%] xl:w-[85%] lg:w-[90%] md:w-[95%] sm:w-[80%] w-[90%] mx-auto">
          <LetsBeginCard onBookQuote={() => setIsFormOpen(true)} obj = {audioBookContent.letBeginsCTA} />
        </section>
