...
function BookFormatting() {
   const { bookformattingContent } = useContext(GlobalContext)
    ...
    <>
      <div className="w-full h-auto flex flex-col">
        ...
        <section className="hero-Section bg-image3 w-full relative py-15 bg-gray-900 flex justify-center items-center">
          <HeroSection onOpenQuote={() => setIsFormOpen(true)} obj = {bookformattingContent.heroSection}  />
        </section>
        ...
        <section className="w-full h-auto flex justify-center">
          <PublishingJourney obj= {bookformattingContent.publishingJourney} />
        </section>

        <section className="2xl:w-[65%] xl:w-[85%] lg:w-[90%] md:w-[95%] sm:w-[80%] w-[90%] mx-auto">
          <CTA onOpenQuote={() => setIsFormOpen(true)}  obj = {bookformattingContent.CTA}/>
        </section>

        <section className="2xl:w-[65%] xl:w-[85%] lg:w-[90%] md:w-[95%] sm:w-[80%] w-[90%] mx-auto">
          <ServiceCard  obj= {bookformattingContent.ourApproach}/>
        </section>

        <section className="2xl:w-[65%] xl:w-[85%] lg:w-[90%] md:w-[95%] sm:w-[80%] w-[90%] mx-auto">
          <LetsBeginCard onBookQuote={() => setIsFormOpen(true)} obj = {bookformattingContent.letBeginsCTA} />
        </section>
